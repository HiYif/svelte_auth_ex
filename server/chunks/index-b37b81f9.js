import { d as requireSafeBuffer, e as requireBufferEqualConstantTime, b as requireEcdsaSigFormatter, r as requireMs, f as requireLruCache, c as commonjsGlobal, g as getDefaultExportFromCjs } from './index-74f74a14.js';
...
function requireSign () {
	...
	const validateAsymmetricKey = requireValidateAsymmetricKey();
	const jws = requireJws();
	const {includes, isBoolean, isInteger, isNumber, isPlainObject, isString, once} = requireLodash();
...
function requireJsonwebtoken () {
	if (hasRequiredJsonwebtoken) return jsonwebtoken.exports;
...
export { jwt as j };
//# sourceMappingURL=index-b37b81f9.js.map
